...
@Service
@Primary
public class EstoqueComControleDeLoteServiceImpl implements EstoqueService {
    private final ProdutoRepository produtoRepository;

    @Autowired
    public EstoqueComControleDeLoteServiceImpl(ProdutoRepository produtoRepository) {
